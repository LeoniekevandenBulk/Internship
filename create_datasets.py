...
for series in trainseries:
    ...
    generate_dataset(
        ...
        series,jump=False,change=False,regression=True,validation=False,normalization=False,one_hot_encoding=False)
    ...
    generate_dataset(
        ...
        "C:\\Users\\Leonieke.vandenB_nsp\\OneDrive - NS\\Data_vertragingen\\Data_RAS\\RollingStockConnectionsAll.txt",
        "C:\\Users\\Leonieke.vandenB_nsp\\OneDrive - NS\\Data_vertragingen\\TrainseriesLocationsCombinations.txt",
        series,jump=False,change=True,regression=True,validation=True,normalization=False,one_hot_encoding=False)
